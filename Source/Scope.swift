...
public final class Scope : ScopeProtocol {
    ...
    internal var isRootScope: Bool {
        get { return _container != nil && parentScope == nil }
    }
    ...
    private func storeNew<Service, Args>(_ resolver: ServiceResolver<Service, Args>, _ instanceKey: InstanceKey<Service, Args>, _ args: Args) -> Service {
        let instance = resolver.resolve(args)
        resolver.postInit?(self, instance)
